    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/spring-boot-mybatisplus/src/main/resources/mapper/" + pc.getModuleName()
        ...
        */
        ...
        // 公共实体
        //strategy.setSuperEntityClass("com.krupp.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        //strategy.setSuperControllerClass("com.krupp.BaseController");
        // 写于父类中的公共字段
